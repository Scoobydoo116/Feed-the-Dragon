...
coin_image_gold = pygame.image.load("coin-gold.png")
coin_rect_gold = coin_image_gold.get_rect()

coin_image_bronze = pygame.image.load("coin-bronze.png")
coin_rect_bronze = coin_image_bronze.get_rect()

coin_image_silver = pygame.image.load("coin-silver.png")
coin_rect_silver = coin_image_silver.get_rect()
 
coin_image = coin_image_bronze
...
while running:
    ...
    if coin_rect.x < 0:
        ...
        if chance == 1:
            ...
            coin_image = coin_image_silver
        else:
            coin_image = coin_image_gold
